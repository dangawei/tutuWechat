     ...
     success: function (res) {
       ...
       if(res.data.code == 0)
       {
         ...
         if (res.data.data.latestPassRecordVO!=null){
          ...
          //判断是否闯过关   检测curren_card_id是否为空

          if (res.data.data.curren_card_id == '' || res.data.data.curren_card_id == null)
          {
            ...
            that.setData({
              type:1,
              existence_unit: res.data.data.curren_unit_name,
              existence_part: res.data.data.curren_part_name,
              part_id: res.data.data.curren_part_id
            })
          }
